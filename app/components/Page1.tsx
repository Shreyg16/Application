...
function Page1() {
  return (
    <>
     <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between px-4 lg:px-10 py-10 lg:py-20 bg-gradient-to-b from-black to-neutral-800 dark:from-neutral-950 dark:to-neutral-800">
      {/* Image Section */}
      <div className="hidden lg:block">
        <Image
          src={BgImg}
          alt=""
          className="w-[600px] rounded-ee-[100px] -mt-16 -ml-12"
        />
      </div>
  ...
  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-8 lg:mt-16 max-w-full md:max-w-2xl text-slate-200">
    HR Software For <br />
    Tech Companies
  </h1>
  <p className="text-sm sm:text-base md:text-lg mt-4 sm:mt-6 lg:mt-10 max-w-full sm:max-w-md lg:max-w-lg text-slate-200 leading-relaxed">
  ...
  <button  className="bg-transparent mt-4 sm:mt-6 lg:mt-10 border border-slate-400 uppercase text-slate-300 px-4 py-2 w-full sm:w-auto md:w-52 rounded-md">
    Request a Call
  </button>
  ...
  <div className="container mx-auto px-4 bg-gradient-to-b from-black to-neutral-800 dark:from-neutral-950 dark:to-neutral-800">
    
  <h1 className="text-center text-3xl sm:text-4xl mt-10 sm:mt-14 text-slate-200">
  ...
  <div className="flex flex-col lg:flex-row mt-8 lg:mt-16">
    ...
    <h2 className="mt-10 ml-0 lg:ml-16 lg:mt-24 text-lg  w-11/12 sm:w-72 sm:text-lg  text-slate-200 text-center lg:text-left mx-auto lg:mx-0">
     Streamline Your Operations
    </h2>

      <p className="mt-4 text-slate-300 text-center lg:text-left max-w-md lg:max-w-[630px] mx-auto lg:ml-16">
        Tie your business systems together into a single, secure place with seamless workflows to give you time back in your day.
      </p>

      <h2 className=" mt-10  ml-0 lg:ml-16 lg:mt-14 text-lg w-11/12 sm:w-72 sm:text-lg  text-slate-200 text-center lg:text-left mx-auto lg:mx-0">
...
<div className="flex flex-col lg:flex-row items-center mt-10 bg-gradient-to-b from-black to-neutral-800 dark:from-neutral-950 dark:to-neutral-800">
  {/* Image Container */}
  ...
  <div className="mt-8 lg:mt-0 lg:ml-16 w-full lg:w-1/2">
    {/* Section 1 */}
    <h2 className="mt-6 lg:mt-32 text-lg  w-11/12 sm:w-[350px] text-slate-200 text-center lg:text-left mx-auto lg:mx-0">
      Leverage Modern, Intuitive Technology
    </h2>
    <p className="mt-4 text-slate-300 text-center lg:text-left max-w-md lg:max-w-[630px] mx-auto lg:ml-0">
    ...
    {/* Section 2 */}
    <h2 className="mt-10 lg:mt-14 text-lg  w-11/12 sm:w-[350px] text-slate-200 text-center lg:text-left mx-auto lg:mx-0">
...
<div className="flex flex-col lg:flex-row mt-8 lg:mt-16 bg-gradient-to-b from-black to-neutral-800 dark:from-neutral-950 dark:to-neutral-800">
  {/* Left Content */}
  <div className="flex-1 px-4 sm:px-8 lg:ml-10">
    <h2 className="mt-10 lg:mt-24 text-lg sm:text-xl text-slate-200 text-center lg:text-left mx-auto lg:mx-16">
